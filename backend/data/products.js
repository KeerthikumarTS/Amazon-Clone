const products = [
    ...
    "name": "ASUS ROG Strix SCAR 16 (2023)",
    "price": 279990,
    "description": "ASUS ROG Strix SCAR 16 (2023) with 90WHr Battery Intel HX-Series Intel Core i9 13th Gen 13980HX - (32 GB/1 TB SSD/Windows 11 Home/12 GB Graphics/NVIDIA GeForce RTX 4080/240 HZ/175 TGP) G634JZ-NM057WS Gaming Laptop  (16 Inch, Black, 2.50 Kg, With MS Office)",
    "ratings": "0",
    "images": [
      {
  ...
  {
    "name": "OnePlus Buds 3 TWS, in Ear Earbuds",
    "price": 5499,
  ...
  {
    "name": "CAMPUS  EVOK Training & Gym Shoes For Men",
    "price": 1227,
    "description": "Step into style and comfort with our exclusive range of shoes, meticulously crafted to enhance your every stride. Whether you're strolling through the city streets or stepping into the boardroom, our shoes are designed to make a statement while keeping you comfortably on your feet all day long.\r\n\r\n",
    "ratings": "0",
    "images": [
      {
  ...
  {
    "name": "Adwait - Chandelier Ceiling Lamp  (Black, Gold)",
    "price": 3999,
    "description": "ADWAIT:-Amazing Decorative ceiling Light. It beautifies your home and office and other places. This ceiling Lamp is in best quality. Will keep your home light for a long time.This Lamp make a style statement above gate and porch and more. This lamp is long lasting and energy efficient.hope you like it",
    "ratings": "0",
    "images": [
      {
  ...
  {
    "name": "Fire-Boltt Dream Smartwatch",
    "price": 5999,
    "description": "WristPhone - 4G SIM/LTE/WiFi, Android OS, Play store unlimited apps, GPS Smartwatch",
    "ratings": "0",
    "images": [
      {
  ...
  {
    "name": "GIGLICK 4XL Bean Bag with Bean Filling  (Black)",
    "price": 2000,
    "description": "Bean Bag Cushion and Footrest Filled with Beans- Black Bean Bag Chair With Bean Filling .",
    "ratings": "0",
    "images": [
      {
    ...
    "category": "Home",
    "seller": "ComfortUniverse",
    "stock": 5,
    "numOfReviews": 0,
    "reviews": []
  },
  {
    "name": "SAMSUNG T7 External Solid State Drive (SSD)  (Grey)",
    "price": 9999,
    "description": "1050 Mbs / PC,Mac,Android / Portable,Type C Enabled / 3Y Warranty / USB 3.2 1 TB External Solid State Drive (SSD) ",
    "ratings": "0",
    "images": [
      {
  ...
  {
    "name": "WROGN  Large 40 L Laptop Backpack",
    "price": 649,
    "description": "Large 40 L Laptop Backpack ASHPER Unisex with USB Port and Rain Cover  (Blue)",
    "ratings": "0",
    "images": [
      {
