                    ...
                    <div className="row d-flex justify-content-between">
                                    ...
                                    <div className="cart-item">
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-2 mt-4 mt-lg-0">
                                                <p id="card_item_price">₹{item.price.toLocaleString('en-IN')}</p>
                                            </div>
                        ...
                        <div className="col-12 col-lg-3 my-4">
                            <div id="order_summary">
                                ...
                                <p>Est. total: <span className="order-summary-values">₹{items.reduce((acc, item)=>(acc + item.quantity * item.price), 0).toLocaleString('en-IN')}</span></p>
